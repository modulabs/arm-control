...
{
class gravity_comp_controller{};
}

template <class State>
class ClosedLoopHardwareInterfaceAdapter<State, Controllers::gravity_comp_controller>
{
public:
...
template <class State>
class HardwareInterfaceAdapter<hardware_interface::EffortJointInterface, State ,Controllers::gravity_comp_controller> : public ClosedLoopHardwareInterfaceAdapter<State ,Controllers::gravity_comp_controller>
{};
