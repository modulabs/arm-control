...
{
  public:
	~TimeDelayController(void)
	{
		//sub_ft_sensor_.shutdown();
	}
...
//		sub_ft_sensor_ = n.subscribe<geometry_msgs::WrenchStamped>("/elfin/elfin/ft_sensor_topic", 1, &TimeDelayController::updateFTsensor, this);
